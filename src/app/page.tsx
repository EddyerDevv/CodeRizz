...
import { DESCRIPTIONS } from "@/constants/landing.consts";
import {
  ArrowRightIcon,
  HistoryIcon,
  MessageSquareIcon,
...
const keyFeatures = [
  {
    icon: <RabbitIcon {...props} />,
    title: "Fast and Easy",
    description:
      "Code Rizz is a fast and easy to use AI chatbot that can help you with your love life.",
  },
  {
    icon: <MessageSquareIcon {...props} />,
    title: "Response Real-time",
    description:
      "You can see the answers in real time, our ai chat is powered for that.",
  },
  {
    icon: <HistoryIcon {...props} />,
    title: "Save History",
    description:
      "We save your history so that you can follow your conversation with our Code Rizz at any time.",
  },
];
    ...
    <Fragment>
      ...
      <main className="flex w-full h-dvh flex-col items-center justify-center relative z-[10] gap-2">
        ...
        <header className="flex flex-col items-center justify-center max-w-[40rem] w-full max-md:max-w-[30rem] mt-4 animate-fade-in-up animate-delay-250 z-30">
          <h1 className="text-[3.9rem] font-semibold font-geistSans text-center leading-[3.75rem] max-md:text-[3rem] max-md:leading-[2.85rem] ">
            Start falling in love with your{" "}
        ...
        <div className="flex flex-col w-full items-center justify-center gap-5 mt-4 z-30">
          <p className="text-[1.425rem] leading-[1.5rem] font-normal text-center max-w-[38rem] text-neutral-400 max-md:text-[1.2rem] max-md:leading-[1.375rem] max-md:max-w-[30rem] animate-fade-in-up animate-delay-500">
            Powered by AI, our answers can be useful for your love chat or rizz
            chat, you can win her over.
          </p>
      ...
      <section className="flex w-full flex-col items-center justify-center px-8 gap-8 py-24">
        ...
        <header className="flex flex-col w-full items-center justify-center ">
          <h1 className="text-[2.25rem] font-bold">Key Features</h1>
          <p className="text-[1.25rem] font-normal text-neutral-400 max-md:text-[1.125rem] max-w-[35rem] text-center leading-[1.325rem]">
            Code Rizz offers good features apart from the main features, you can
            see in our github which features we have
          </p>
        </header>
        ...
        <article className="py-6 px-8 rounded-3xl w-full max-w-[60rem] min-h-[22rem] items-center justify-center flex background-blue-purple-diagonal-dark max-[880px]:flex-col-reverse max-[880px]:items-start gap-4">
          <div className="flex flex-col min-w-md max-w-[35.7rem] flex-1 items-start gap-2">
            ...
            <p className="leading-[1.6rem] text-white/60 text-[1.25rem] max-md:text-[1.1rem] max-md:leading-[1.2rem]">
              This is for educational purposes only, it will be available for
              the Vercel hackathon with midudev.
            </p>
            ...
            <div className="flex flex-col items-start gap-x-[2rem] gap-y-[2rem] md:flex-row md:items-center">
              <div className="flex flex-row items-center gap-[0.4rem] text-[0.9rem] font-semibold">
                <figure className="flex items-center">
                  ...
                  />
                  <figcaption className="sr-only">Logo de Code Rizz</figcaption>
                </figure>
