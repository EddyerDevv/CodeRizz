    ...
    return (
        <Fragment>
            ...
            <main className="flex w-full h-dvh flex-col items-center justify-center relative z-[10] gap-2">
                <div
                    className="size-full z-[20] absolute pointer-events-none overflow-hidden flex items-center justify-center">
                    <div
                        className="text-[50rem] blur-3xl absolute -rotate-[75deg] left-0 bottom-[-25%] opacity-30 max-md:text-[30rem] max-md:bottom-auto">
                        /
                    </div>
                </div>
          ...
          <span className="font-geistSans text-[1.08825rem] leading-[0]">
            {t('header.linkButton')}
                ...
                <header
                    className="flex flex-col items-center justify-center max-w-[40rem] w-full max-md:max-w-[30rem] mt-4 animate-fade-in-up animate-delay-250 z-30">
            ...
            <div className="flex w-full flex-col items-center justify-center pb-4 relative top-[-12%]">
                <section
                    ...
                    <div
                        className="size-full rounded-lg bg-white/5 flex flex-col items-center justify-center max-md:rounded-none ">
            ...
            <section className="flex w-full flex-col items-center justify-center px-8 gap-8 py-24">
                ...
                <div className="size-full z-[20] absolute pointer-events-none overflow-hidden">
                    <div
                        className="text-[64rem] absolute blur-3xl -rotate-[90deg] top-[-80%] opacity-15 max-md:text-[40rem] max-md:top-[-25%] max-md:opacity-30">
                        /
                    </div>
                </div>
            ...
            <section className="flex w-full flex-col items-center justify-center px-8 gap-8">
                <article
                    className="py-6 px-8 rounded-3xl w-full max-w-[60rem] min-h-[22rem] items-center justify-center flex background-blue-purple-diagonal-dark max-[880px]:flex-col-reverse max-[880px]:items-start gap-4">
                    <div className="flex flex-col min-w-md max-w-[35.7rem] flex-1 items-start gap-2">
                        ...
                        >
              <span
                  className="font-geistSans text-[1.375rem] font-semibold bg-gradient-to-r from-red-500 to-pink-500 text-transparent bg-clip-text">
                {t('actions.startNowButton')}
              </span>
                        </Link>
                    </div>
            ...
            <footer className="mx-8 mt-auto flex flex-col items-center pb-[2.77rem]">
                <div className="flex flex-col mx-8 w-full max-w-[60rem] gap-8">
                    <div className="flex flex-row items-end justify-between gap-x-2 sm:flex-row sm:items-center">
                        <div
                            className="flex flex-col items-start gap-x-[2rem] gap-y-[2rem] md:flex-row md:items-center">
                ...
                <span className="font-semibold text-[1.05rem] font-geistSans leading-[0]">
                  {t('actions.chat')}
                    ...
                    />
                    <div
                        className="flex flex-row flex-wrap justify-between gap-x-8 gap-y-4 text-[0.7rem] text-white/50">
